package com.donghh.studentmanagement.ui.notifications;
...
import com.donghh.studentmanagement.databinding.FragmentNotificationsBinding;
...
public class NotificationsFragment extends Fragment {
    ...
    //danh sách hóa đơn
    private ArrayList<Payment> listBill = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        listBill = databaseHandler.getAllPayment();
        initData();
...
//            l.setXEntrySpace(4f);
    ...
    private void getBarEntries() {
        ...
        for (int i = 1; i <= 12; i++) {
            ...
            ArrayList<Payment> billsMonth = databaseHandler.getAllBillByForDate(startDate, startEnd);

            double totalMoney = 0;
            if (billsMonth.size() > 0) {
                for (Payment bill : billsMonth) {
                    totalMoney += bill.getRoomBill()+bill.getWaterBill()+bill.getRoomBill();
                }
            }
