...
class SpinnerRoomAdapter extends BaseAdapter {

    private List<Room> list;

    private Context context;

    public SpinnerRoomAdapter(Context context,
                              List<Room> list) {
    ...
    public long getItemId(int position) {
        Room language = (Room) this.getItem(position);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(list.get(position).getRoomName());
        return view;
    }
}